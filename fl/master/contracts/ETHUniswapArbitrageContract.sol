...
// Ixs Token (IXS)
// IX Swap is the “Uniswap” for security tokens (STO) and tokenized stocks (TSO). IX Swap will be the FIRST platform to provide liquidity pools and automated market making 
s for the security token (STO) & tokenized stock industry (TSO).
// 0x73d7c860998ca3c01ce8c808f5577d94d545d1b4
